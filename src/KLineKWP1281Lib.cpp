...
float KLineKWP1281Lib::getMeasurementValue(uint8_t measurement_index, uint8_t amount_of_measurements, uint8_t* measurement_buffer, size_t measurement_buffer_size)
{
  ...
  */
  ...
  switch (formula) {
    ...
    case 0x28: result = a * 255.0 / 10.0 + b * 0.1 - 400.0;                                                    break; //Current             [A]
    ...
    case 0x4E: result = int8_t(b) * 1819.0 * 0.001;                                                            break; //Misfires            [/s]
    ...
    case 0x78: result = a * b * 141.1752 * 0.01;                                                               break; //Angle               [deg]
    ...
    case 0xAF: result = a * b * 5.0 * 0.001;                                                                   break; //N/A                 [bar]
