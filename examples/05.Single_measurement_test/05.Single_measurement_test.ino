  ...
  switch (measurement_type)
  {
    ...
    case KLineKWP1281Lib::VALUE:
    {
      ...
      if (!received_group_header)
      {
        ...
        Serial.print(KLineKWP1281Lib::getMeasurementValue(measurement_index, amount_of_measurements, measurement_buffer, sizeof(measurement_buffer)), decimals);
        Serial.print(' ');
        Serial.println(KLineKWP1281Lib::getMeasurementUnits(measurement_index, amount_of_measurements, measurement_buffer, sizeof(measurement_buffer), units_string, sizeof(units_string)));
      }
      // "Header+body" mode:
      else
      {
        ...
        // Display the calculated value, with the recommended amount of decimals.
        Serial.print(KLineKWP1281Lib::getMeasurementValueFromHeaderBody(measurement_index, amount_of_measurements_in_header, measurement_buffer, sizeof(measurement_buffer), amount_of_measurements, measurement_body_buffer, sizeof(measurement_body_buffer)), decimals);
        Serial.print(' ');
        Serial.println(KLineKWP1281Lib::getMeasurementUnitsFromHeaderBody(measurement_index, amount_of_measurements_in_header, measurement_buffer, sizeof(measurement_buffer), amount_of_measurements, measurement_body_buffer, sizeof(measurement_body_buffer), units_string, sizeof(units_string)));
      }
    }
    break;
    ...
    case KLineKWP1281Lib::TEXT:
    {
      ...
      if (!received_group_header)
      {
        ...
        Serial.println(KLineKWP1281Lib::getMeasurementText(measurement_index, amount_of_measurements, measurement_buffer, sizeof(measurement_buffer), text_string, sizeof(text_string)));
      }
      else
      {
        // The function getMeasurementTextFromHeaderBody() returns the same string that it's given. It's the same as text_string.
        Serial.println(KLineKWP1281Lib::getMeasurementTextFromHeaderBody(measurement_index, amount_of_measurements_in_header, measurement_buffer, sizeof(measurement_buffer), amount_of_measurements, measurement_body_buffer, sizeof(measurement_body_buffer), text_string, sizeof(text_string)));
      }
    }
    break;
