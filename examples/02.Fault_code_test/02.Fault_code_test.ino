/*
  ...
  Notes:
    ...
    *If you are using the ESP32 platform, feel free to uncomment the lines "#define KWP1281_FAULT_CODE_DESCRIPTION_SUPPORTED" and
    "#define KWP1281_OBD_FAULT_CODE_DESCRIPTION_SUPPORTED" in "KLineKWP1281Lib.h", in order to get descriptive names associated with each fault code.
    ...
    *If you have descriptions enabled, you can choose from a few different languages a bit further below in "KLineKWP1281Lib.h". Please only choose
    one option.
    *If these are left disabled, the descriptions will be replaced by "EN_dsc"/"EN_obd".
